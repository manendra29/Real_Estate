        ...
        <div className="col-span-12 font-roboto text-justify">
          ...
          <div className="flex flex-col gap-8 pb-8 text-sm lg:text-xl">
            ...
            <p>
              ...
              transactions and SkyViewEstates REALTORS assumes no responsibility
            ...
            <p>
              ...
              agree that SkyViewEstates REALTORS may use personal information
            ...
            <p>
              You agree that SkyViewEstates REALTORS may use your personal
            ...
            <p>
              All SkyViewEstates REALTORS websites including this website fully
              comply with all Indian Laws applicable. SkyViewEstates REALTORS has
            ...
            <p>
              SkyViewEstates REALTORS has taken all reasonable steps to ensure
              that all the information on this website is authentic. Users are
              advised to research independently the credentials of the
              advertisers provided on this website. SkyViewEstates REALTORS shall
              ...
              information on this aspect. SkyViewEstates REALTORS has implemented
              and uses Display Advertising. SkyViewEstates REALTORS is using
